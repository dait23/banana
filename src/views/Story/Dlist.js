                 ...
                 {this.renderImage()}
                   ...
                   <div className="post-content">
                    <a href={`/@${this.props.post.user.username}/${this.props.post.slug}`}>  <h4 className="post-title">{this.props.post.title}</h4></a>
                     ...
                     <span className="post-date" style={{marginLeft:'-0px', marginTop:'-5px'}}>{createDT} &nbsp;{this.renderPublish()} - &nbsp;{this.props.post.reading} min read &nbsp;&nbsp;&nbsp; {this.props.post.read} Reads  &nbsp;&nbsp;&nbsp;  {this.props.post._commentsMeta.count} Respone &nbsp;&nbsp;&nbsp;  {this.props.post._reportsMeta.count}  Report</span> 
