                        ...
                        <Form>
                         ...
                         <FormGroup row>
                            ...
                            <Col sm={10} style={{border:'1px solid #eee'}}>
                              ...
                              />
                               <textarea  hidden className="form-control" id="area" name="description" rows="5" value={draftToHtml(convertToRaw(editorState.getCurrentContent()))}  style={{display:'block'}}
