         ...
         <div>
              ...
              <div className="post-type-florida">
                ...
                <div className="post-content" style={{height:'150px'}}>
                  ...
                  <span className="post-author">{this.renderThumb()}<a href={`/@${this.props.post.user.username}`}>{this.props.post.user.member.firstName} {this.props.post.user.member.lastName}</a></span>
