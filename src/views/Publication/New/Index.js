...
import {MainLink, Cloudinary_Code, Cloudinary_Link, Cloudinary_Name} from '../../Api/';
...
renderTopics(){
  ...
  render() {
             ...
             <div className="col-md-8">
               ...
               <div className="new-content">
                  ...
                  <FormGroup row>
                    ...
                    <Col sm={10}>
                      <Input type="text" value={this.state.web} name="web"  placeholder="http://" style={{height:'50px', fontSize:'16px'}}
   ...
   handlePost = async () => {
    ...
    const { name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, web, facebook, twitter, instagram, writtersIds } = this.state
  
    await this.props.createPublishMutation({variables: { name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, web, facebook, twitter, instagram, userId, writtersIds }})
