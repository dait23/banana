...
class Dlist extends Component {
  ...
  renderStatus(){
    ...
    if(this.props.post.user.id == localStorage.getItem('uid')){
    ...
    if(this.props.post.user.id == localStorage.getItem('uid')){
      ...
      return(
        ...
        <div>
                     ...
                     <span className="pull-right"  style={{fontSize:'13px', marginLeft:'10px'}} ><a href={`/me/publication/stats-publish/${this.props.post.id}`}>Stats</a></span>
      ...
      return(
                  <div>
                     <span className="pull-right"  style={{fontSize:'13px', marginLeft:'10px'}} ><a href={`/me/publication/stats-writter/${this.props.post.id}`}>Stats</a></span>
                     <span className="pull-right"  style={{fontSize:'13px'}} ><a href={`/me/publication/new-story/${this.props.post.id}`}>New Stories</a></span>
                </div>
