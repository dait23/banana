...
renderWritter(){
  ...
  render() {
             ...
             <div className="col-md-8">
               ...
               <div className="new-content">
                   ...
                   <FormGroup row>
                    ...
                    <Col sm={10}>
                      <Input type="email" value={this.state.web} name="web"  placeholder="your publishing website" style={{height:'50px', fontSize:'16px'}}
   ...
   handlePost = async () => {
    ...
    const { id, name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, twitter, instagram, writtersIds, web } = this.state
  
    await this.props.createPublishMutation({variables: { id, name, slug, description, avatarId, avatarUrl, topicsIds, coverId, coverUrl, email, facebook, web, twitter, instagram, userId, writtersIds }})
