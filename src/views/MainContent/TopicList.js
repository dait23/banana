...
renderThumb(){
    ...
    if(this.props.post.user.avatar == '' ){
     ...
     return(
         ...
         <img src={pic} className="img-circle hidden-sm hidden-xs" style={{margin:'0px 5px 0 0px', width:'33px'}} />
        ...
        return(
         ...
         <img src={this.props.post.user.avatar} className="img-circle hidden-sm hidden-xs" style={{margin:'0px 5px 0 0px', width:'30px'}} />
